    ...
    return (
        <CardGroup style={{ width: '1425px' }} className="rounded mx-auto bg-secondary">
            <Card className="bg-secondary">
                <Card.Img variant="top" className='p-1' src="./images/loc_1.jpg" />
                <Card.Body>
            ...
            <Card className="bg-secondary">
                <Card.Img variant="top" className='p-1' src="./images/loc_2.jpg" />
                <Card.Body>
            ...
            <Card className="bg-secondary">
                <Card.Img variant="top" className='p-1' src="./images/loc_3.jpg" />
                <Card.Body>
